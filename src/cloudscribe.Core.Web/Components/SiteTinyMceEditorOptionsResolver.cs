...
{
    public class SiteTinyMceEditorOptionsResolver : ITinyMceEditorOptionsResolver
    {
        public SiteTinyMceEditorOptionsResolver(
            IOptions<TinyMceEditorOptions> mceOptionsAccessor,
            ...
            )
        {
            ...
            _options = mceOptionsAccessor.Value;
        }

        private TinyMceEditorOptions _options;
        ...
        public Task<TinyMceEditorOptions> GetTinyMceEditorOptions()
        {
            ...
            var result = new TinyMceEditorOptions();
