...
namespace cloudscribe.Core.Web
{
    ...
    public static class PolicyConstants
    {
        ...
        public const string ServerAdminPolicy = "ServerAdminPolicy";
        public const string RoleAdminPolicy = "RoleAdminPolicy";
        public const string RoleLookupPolicy = "RoleLookupPolicy";
