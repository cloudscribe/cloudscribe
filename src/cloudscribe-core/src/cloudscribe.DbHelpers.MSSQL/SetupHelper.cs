...
//        public SetupHelper(ILoggerFactory loggerFactory)
//        {
//            logFactory = loggerFactory;
//            db = new Db(logFactory);

//        }

//        public DbDataReader GetApplicationId(string applicationName)
//        {
//            return db.GetReader(
...
//            using (DbDataReader reader = GetSchemaVersion(applicationId))
//            {
//                if (reader.Read())
//                {
//                    result = true;
...
//        public DbDataReader GetSchemaVersion(Guid applicationId)
//        {
//            SqlParameterHelper sph = new SqlParameterHelper(
//                logFactory,
//                ConnectionString.GetReadConnectionString(), 
...
//                logFactory,
//                ConnectionString.GetReadConnectionString(), 
//                "mp_SchemaVersion_SelectNonCore", 
//                0);
//            return sph.ExecuteReader();
//        }
...
//                logFactory,
//                ConnectionString.GetReadConnectionString(), 
//                "mp_SchemaScriptHistory_SelectOne", 
//                1);
//            sph.DefineSqlParameter("@ID", SqlDbType.Int, ParameterDirection.Input, id);
//            return sph.ExecuteReader();
//        }
...
//                logFactory,
//                ConnectionString.GetReadConnectionString(), 
//                "mp_SchemaScriptHistory_SelectByApp", 
//                1);
//            sph.DefineSqlParameter("@ApplicationID", SqlDbType.UniqueIdentifier, ParameterDirection.Input, applicationId);
//            return sph.ExecuteReader();
//        }
...
//                logFactory,
//                ConnectionString.GetReadConnectionString(), 
//                "mp_SchemaScriptHistory_SelectErrorsByApp", 
//                1);
