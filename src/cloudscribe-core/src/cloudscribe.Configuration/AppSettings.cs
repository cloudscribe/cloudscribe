...
namespace cloudscribe.Configuration
{
    public static class AppSettings
    {
        ...
        public static bool GetBool(string key, bool defaultIfNotFound)
        {
            ...
            if (Config.Get(key) == null) { return defaultIfNotFound; }

            if (string.Equals(Config.Get(key), "true", StringComparison.CurrentCultureIgnoreCase))
            { return true; }

            if (string.Equals(Config.Get(key), "false", StringComparison.CurrentCultureIgnoreCase))
            { return false; }
        ...
        public static int GetInt(string key, int defaultValue)
        {
            ...
            int setting;
            return int.TryParse(Config.Get(key), out setting) ? setting : defaultValue;
        }
        ...
        public static long GetLong(string key, long defaultValue)
        {
            if (string.IsNullOrEmpty(key)) { return defaultValue; }
            long setting;
            return long.TryParse(Config.Get(key), out setting) ? setting : defaultValue;
        }
