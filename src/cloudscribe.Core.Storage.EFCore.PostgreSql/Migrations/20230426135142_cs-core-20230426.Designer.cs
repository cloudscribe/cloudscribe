...
namespace cloudscribe.Core.Storage.EFCore.PostgreSql.Migrations
{
    ...
    [Migration("20230426135142_cs-core-20230426")]
    partial class cscore20230426
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cloudscribe.Core.Models.SiteSettings", b =>
                {
                    ...
                    b.Property<string>("SmtpOauthAuthorizeEndpoint")
                        .HasColumnType("text")
                        .HasColumnName("smtp_oauth_authorize_endpoint");

                    b.Property<string>("SmtpOauthClientId")
                        .HasColumnType("text")
                        .HasColumnName("smtp_oauth_client_id");

                    b.Property<string>("SmtpOauthClientSecret")
                        .HasColumnType("text")
                        .HasColumnName("smtp_oauth_client_secret");

                    b.Property<string>("SmtpOauthScopesCsv")
                        .HasColumnType("text")
                        .HasColumnName("smtp_oauth_scopes_csv");

                    b.Property<string>("SmtpOauthTokenEndpoint")
                        .HasColumnType("text")
                        .HasColumnName("smtp_oauth_token_endpoint");
            ...
            modelBuilder.Entity("cloudscribe.Core.Models.UserInteractiveServiceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CloudscribeServiceProvider")
                        .HasColumnType("text")
                        .HasColumnName("cloudscribe_service_provider");
                    ...
                    b.Property<DateTime?>("TokenExpiresUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("token_expires_utc");

                    b.Property<bool>("TokenHasExpired")
                        .HasColumnType("boolean")
                        .HasColumnName("token_has_expired");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_cs_user_interactive_service_token");

                    b.HasIndex("CloudscribeServiceProvider")
                        .HasDatabaseName("ix_cs_user_interactive_service_token_cloudscribe_service_provi");

                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_cs_user_interactive_service_token_site_id");

                    b.ToTable("cs_user_interactive_service_token", (string)null);
                });
