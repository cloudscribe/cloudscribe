...
t.on("click",function(){var n=t.data("disabled-text")
n&&t.val(n)})})}}
$(document).ready(function(){$("form[data-submit-once='true']").addTriggersToJqueryValidate(),t.disableButtonsOnClick(),$("form[data-submit-once='true']").formValidAndInvalid(function(n){t.enableButtons()},function(n){t.enableButtons()})})}()
