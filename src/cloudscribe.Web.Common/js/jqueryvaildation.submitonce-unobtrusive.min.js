...
t.on("click",function(){var n=t.data("disabled-text")
n&&t.val(n)})})}}
$(document).ready(function(){$("form[data-submit-once='true']").addTriggersToJqueryValidate(),t.disableButtonsOnClick(),$("form[data-submit-once='true']").formValidAndInvalid(function(t){},function(n){t.enableButtons()})})}()
