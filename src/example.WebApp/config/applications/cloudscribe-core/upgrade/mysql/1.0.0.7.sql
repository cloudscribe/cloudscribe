...
ALTER TABLE mp_Sites ADD COLUMN `FacebookAppSecret` varchar(100);

ALTER TABLE mp_Sites ADD COLUMN `GoogleClientId` varchar(100);
ALTER TABLE mp_Sites ADD COLUMN `GoogleClientSecret` varchar(100);
ALTER TABLE mp_Sites ADD COLUMN `TwitterConsumerKey` varchar(100);
ALTER TABLE mp_Sites ADD COLUMN `TwitterConsumerSecret` varchar(100);
ALTER TABLE mp_Sites ADD COLUMN `MicrosoftClientId` varchar(100);
ALTER TABLE mp_Sites ADD COLUMN `MicrosoftClientSecret` varchar(100);
