...
namespace cloudscribe.Core.Identity
{
    ...
    //public class SiteOpenIdConnectOptionsPreview : IOptionsSnapshot<OpenIdConnectOptions>
    //{
    //    public SiteOpenIdConnectOptionsPreview(
    //        IOptions<MultiTenantOptions> multiTenantOptionsAccessor,
    //        IPostConfigureOptions<OpenIdConnectOptions> optionsInitializer,
    //        IDataProtectionProvider dataProtection,
    //        IHttpContextAccessor httpContextAccessor,
    //        ILogger<SiteOpenIdConnectOptionsPreview> logger
    //        )
    //    {
    //        _multiTenantOptions = multiTenantOptionsAccessor.Value;
    //        _httpContextAccessor = httpContextAccessor;
