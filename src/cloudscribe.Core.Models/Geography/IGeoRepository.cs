...
namespace cloudscribe.Core.Models.Geography
{
    public interface IGeoRepository
    {
        ...
        Task<bool> Save(IGeoCountry geoCountry, CancellationToken cancellationToken);
        Task<bool> Save(IGeoZone geoZone, CancellationToken cancellationToken);

        Task<bool> Save(ILanguage language, CancellationToken cancellationToken);
        ...
        Task<bool> Save(ICurrency currency, CancellationToken cancellationToken);
