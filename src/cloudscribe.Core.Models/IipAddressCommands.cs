...
namespace cloudscribe.Core.Models
{
    public interface IipAddressCommands
    {
        ...
        Task<bool> AddPermittedIpAddress(BlockedPermittedIpAddressesModel blockedPermittedIpAddressesModel, Guid currentSiteId, CancellationToken cancellationToken);
        Task<bool> UpdatePermittedIpAddress(BlockedPermittedIpAddressesModel blockedPermittedIpAddressesModel, Guid currentSiteId, CancellationToken cancellationToken);
        ...
        Task<bool> AddBlockedIpAddress(BlockedPermittedIpAddressesModel blockedPermittedIpAddressesModel, Guid currentSiteId, CancellationToken cancellationToken);
        Task<bool> UpdateBlockedIpAddress(BlockedPermittedIpAddressesModel blockedPermittedIpAddressesModel, Guid currentSiteId, CancellationToken cancellationToken);
