...
| Windows  | Linux/Mac |
| ------------- | ------------- |
| [![Build status](https://ci.appveyor.com/api/projects/status/jt9c0022x3odacar?svg=true)](https://ci.appveyor.com/project/joeaudette/cloudscribe)  | [![Build Status](https://travis-ci.org/joeaudette/cloudscribe.svg?branch=master)](https://travis-ci.org/joeaudette/cloudscribe)  |
